...
require_role_or_permission(['seller'], 'daily_summary.view');
...
// Per-page summary for this seller in selected date range
$sql = 'SELECT p.name AS page_name,
...
<div class="d-flex flex-column h-100">
    <div class="d-flex flex-wrap justify-content-between align-items-center mb-3 gap-2">
        <h1 class="h4 mb-0">Daily Summary</h1>
        <a href="orders.php" class="btn btn-outline-secondary btn-lg">Back to My Orders</a>
    </div>
    ...
    <form method="get" class="card shadow-sm mb-3">
        <div class="card-body row g-3 align-items-end">
            ...
            <div class="col-12 col-md-4 d-flex gap-2">
                ...
                <a href="daily.php" class="btn btn-outline-secondary btn-lg w-100">Today</a>
            </div>
        </div>
    </form>
        ...
        <div class="card-body d-flex flex-column p-0">
            <div class="table-responsive table-responsive-full">
                <table class="table table-hover align-middle mb-0">
                    ...
                    <tbody>
                    <?php if (!$rows): ?>
                        <tr><td colspan="8" class="text-center py-4">No orders for this date.</td></tr>
                    <?php else: ?>
                        <?php $no = 1; ?>
                        <?php foreach ($rows as $r): ?>
                        <tr>
                            <td><?= $no++ ?></td>
                            <td><?= htmlspecialchars($r['page_name'] ?? 'No page') ?></td>
